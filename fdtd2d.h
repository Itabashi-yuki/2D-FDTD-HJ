...
constexpr double Ne_max { 1.0e12 };
...
/* Plasma parameters */
// constexpr double Rx_iono_lower { 80.0e3 };
// constexpr double Ry_iono_lower { 0.0 };
// constexpr double Rx_iono_upper { 100.0e3};
// constexpr double Ry_iono_upper { 100.0e3 };
// constexpr double Rx_iono_lower { Rx - 20.0e3 };
constexpr double Rx_iono_lower { 60.0e3 };
constexpr double Ry_iono_lower { 0 };
constexpr double Rx_iono_upper { Rx };
constexpr double Ry_iono_upper { Ry };

constexpr double Nx_iono_lower { int(Rx_iono_lower / dx)};
constexpr double Ny_iono_lower { int(Ry_iono_lower / dy)};
constexpr double Nx_iono_upper { int(Rx_iono_upper / dx) - 1};
constexpr double Ny_iono_upper { int(Ry_iono_upper / dy) - 1};
...
/* obs parameters */
// constexpr double obs_x { 70.0e3 };
// constexpr double obs_y { 50.0e3 };
constexpr double obs_x { Rx / 2.0 };
constexpr double obs_y { Ry / 2.0 };
...
void update_Dz_PML(double ***Dz, double ***Dzx, double ***Dzy, double **Hx, double **Hy,
                     double *CDZX1, double *CDZX2, double *CDZY1, double *CDZY2, int n);
